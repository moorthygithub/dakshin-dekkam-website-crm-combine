...
const Info = () => {
  ...
  return (
    <section className="relative py-20 bg-[#faf7f7]">
      <div className="container mx-auto max-w-screen-xl px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 text-black" data-aos="fade-right">
            <div className="flex items-center relative mb-6">
              <div
                className="rounded-full w-12 h-12 absolute -left-4 -top-3 animate-pulse"
            ...
            <h1 className="text-xl md:text-2xl font-extrabold text-darken mb-6 leading-snug">
              <span style={{ color: "#db2920" }}>Dakshin</span> Bharat K.D.O.
              Jain Ekkam
            </h1>
            ...
            <div
              className="bg-white shadow-lg rounded-xl p-6 mt-2"
              style={{ border: "1px solid #f5c6c4" }}
            >
              <h3
                className="text-xl font-semibold text-darken mb-4 pb-2"
                style={{ borderBottom: "1px solid #f5c6c4" }}
              >
                Membership Details
              </h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-gray-700 mt-2 space-y-1">
                    <li>
                      <strong>Eligibility:</strong> Registered Society, Trust,
                      or Mahajan with 75+ members of the KDO Jain community of
                      South India
                    </li>
                    <li>
                      <strong>Fee:</strong> ₹501 (one-time)
          ...
          <div className="lg:col-span-5 relative flex justify-center items-center">
            <div className="relative w-full max-w-md bg-white rounded-2xl p-8 lg:p-12 shadow-lg overflow-hidden">
              <MemberForm />
              <div
                className="absolute -top-8 -left-8 w-24 h-24 rounded-full animate-pulse opacity-70"
                style={{ background: "#fad5d3" }}
              ></div>
              <div
                className="absolute top-6 -right-6 w-8 h-8 rounded-full animate-ping opacity-80"
                style={{ background: "#f5c6c4" }}
              ></div>
              <div
                className="absolute -bottom-8 -right-8 w-20 h-20 rounded-full animate-pulse opacity-70"
                style={{ background: "#db2920" }}
              ></div>
              <div
                className="absolute -bottom-10 left-4 w-12 h-12 rounded-full animate-ping opacity-80"
                style={{ background: "#9b1c15" }}
              ></div>
            </div>
          </div>
        </div>
